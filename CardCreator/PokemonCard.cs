...
namespace CardCreator
{
    public class PokemonCard
    {
        ...
        public string buildFromTemplate(string setName)
        {
            ...
            code = code.Replace(templateClassName, generateSafeClassName(Name));
            ...
            {
                code = code.Replace(templateEvolvesFrom, $"EvolvesFrom = \"{EvolvesFrom}\"; //TODO: Add stage");
            }
            else
            {
                code = code.Replace(templateEvolvesFrom, "Stage = 0;");
            }
